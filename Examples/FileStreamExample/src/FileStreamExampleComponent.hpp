...
//#component
class FileStreamExampleComponent : public ComponentBase, public ProgramComponentBase, private Loggable<FileStreamExampleComponent>
{
public: // typedefs

public: // construction/destruction
    FileStreamExampleComponent(ILibrary& library, const String& name);
