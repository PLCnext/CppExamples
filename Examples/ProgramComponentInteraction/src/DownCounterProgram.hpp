...
class DownCounterProgram : public ProgramBase, private Loggable<DownCounterProgram>
{
public: // typedefs

public: // construction/destruction
    DownCounterProgram(ProgramComponentInteraction::CounterComponent& counterComponentArg, const String& name);
...
inline DownCounterProgram::DownCounterProgram(ProgramComponentInteraction::CounterComponent& counterComponentArg, const String& name)
: ProgramBase(name)
